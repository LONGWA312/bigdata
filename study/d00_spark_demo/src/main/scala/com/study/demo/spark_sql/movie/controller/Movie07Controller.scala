...
import com.study.demo.spark_sql.movie.service.{Movie06Service, Movie07Service}


class Movie07Controller extends BaseController {

    private val service = new Movie07Service()
