...
import com.study.demo.spark_sql.movie.service.{Movie07Service, Movie08Service}


class Movie08Controller extends BaseController {

    private val service = new Movie08Service()
