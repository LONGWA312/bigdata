...
import com.study.demo.spark_sql.movie.service.{Movie09Service, Movie10Service}


class Movie10Controller extends BaseController {

    private val service = new Movie10Service()
